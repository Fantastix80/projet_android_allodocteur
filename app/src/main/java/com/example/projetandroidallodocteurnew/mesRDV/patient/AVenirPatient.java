...
public class AVenirPatient extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_a_venir_patient, container, false);
        ...
        databaseManager.getRDVAVenir("patient", sessionManager.getEmail(), listenerAVenir);
